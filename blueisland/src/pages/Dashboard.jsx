          ...
          <motion.div {...fadeUp(0.3)} className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-brand-600 to-sky-500 rounded-2xl p-5 text-white">
              ...
              <div className="mt-4 pt-4 border-t border-white/20 space-y-2">
                <a href="tel:+917984237914" className="flex items-center gap-2 text-white/80 text-xs hover:text-white">
                  <i className="fas fa-phone w-3" />+91 79842 37914
                </a>
                <a href="https://wa.me/917984237914" target="_blank" rel="noreferrer"
